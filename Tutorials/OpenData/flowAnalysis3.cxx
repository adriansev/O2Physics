...
struct flow_base {
  ...
  Configurable<float> magField{"magField", 99999, "Configurable magnetic field; default CCDB will be queried"};
    Configurable<bool> rofCut{"rofCut", false, "activate rof cut"};
  ...
  TF1* fPhiCutHigh = nullptr;
    ...
    //TF1* fMultMultPVCutLow = nullptr;
    //TF1* fMultMultPVCutHigh = nullptr;
  ...
  void init(InitContext&)
  {
    ...
    histos.add("QA/QABetaP", "#beta p", kTH3F, {{axisQAP}, {axisQABeta}, {axisCentBins}});
      ...
      fMultPVCutLow->SetParameters(3126.93, -110.617, 1.61648, -0.0119659, 3.78063e-05, 187.536, -5.64215, 0.108717, -0.00128019, 5.87089e-06);
      
      fMultPVCutHigh = new TF1("fMultPVCutHigh", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x + 3.5*([5]+[6]*x+[7]*x*x+[8]*x*x*x+[9]*x*x*x*x)", 0, 100);
      fMultPVCutHigh->SetParameters(3126.93, -110.617, 1.61648, -0.0119659, 3.78063e-05, 187.536, -5.64215, 0.108717, -0.00128019, 5.87089e-06);
      
        
      fMultCutLow = new TF1("fMultCutLow", "[0]+[1]*x+[2]*x*x+[3]*x*x*x - 2.5*([4]+[5]*x+[6]*x*x+[7]*x*x*x+[8]*x*x*x*x)", 0, 100);
      fMultCutLow->SetParameters(1695.85, -48.6217, 0.469536, -0.00152317, 162.466, -4.42477, 0.0668145, -0.000687501, 3.12718e-06);
      
      fMultCutHigh = new TF1("fMultCutHigh", "[0]+[1]*x+[2]*x*x+[3]*x*x*x + 3.*([4]+[5]*x+[6]*x*x+[7]*x*x*x+[8]*x*x*x*x)", 0, 100);
      fMultCutHigh->SetParameters(1695.85, -48.6217, 0.469536, -0.00152317, 162.466, -4.42477, 0.0668145, -0.000687501, 3.12718e-06);
      ...
      fMultPVCutLow = new TF1("fMultPVCutLow", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x - 3.5*([5]+[6]*x+[7]*x*x+[8]*x*x*x+[9]*x*x*x*x)", 0, 100);
      fMultPVCutLow->SetParameters(3326.11, -117.359, 1.69522, -0.0122721, 3.76947e-05, 163.633, -4.27327, 0.0738094, -0.000874738, 4.15996e-06);
      
      fMultPVCutHigh = new TF1("fMultPVCutHigh", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x + 3.5*([5]+[6]*x+[7]*x*x+[8]*x*x*x+[9]*x*x*x*x)", 0, 100);
      fMultPVCutHigh->SetParameters(3326.11, -117.359, 1.69522, -0.0122721, 3.76947e-05, 163.633, -4.27327, 0.0738094, -0.000874738, 4.15996e-06);
      
        
      fMultCutLow = new TF1("fMultCutLow", "[0]+[1]*x+[2]*x*x+[3]*x*x*x - 3*([4]+[5]*x+[6]*x*x+[7]*x*x*x+[8]*x*x*x*x)", 0, 100);
      fMultCutLow->SetParameters(1914.7, -55.3429, 0.540844, -0.00178566, 93.0525, -1.09988, 0.00558029, -0.000173367, 1.47086e-06);
      
      fMultCutHigh = new TF1("fMultCutHigh", "[0]+[1]*x+[2]*x*x+[3]*x*x*x + 3.*([4]+[5]*x+[6]*x*x+[7]*x*x*x+[8]*x*x*x*x)", 0, 100);
      fMultCutHigh->SetParameters(1914.7, -55.3429, 0.540844, -0.00178566, 93.0525, -1.09988, 0.00558029, -0.000173367, 1.47086e-06);
       */
      ...
      fMultPVCutLow = new TF1("fMultPVCutLow", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x - 3.5*([5]+[6]*x+[7]*x*x+[8]*x*x*x+[9]*x*x*x*x)", 0, 100);
      fMultPVCutLow->SetParameters(3167.6, -112.138, 1.64184, -0.0121816, 3.85466e-05, 174.782, -5.20096, 0.102772, -0.00123916, 5.73468e-06);
      
      fMultPVCutHigh = new TF1("fMultPVCutHigh", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x + 3.5*([5]+[6]*x+[7]*x*x+[8]*x*x*x+[9]*x*x*x*x)", 0, 100);
      fMultPVCutHigh->SetParameters(3167.6, -112.138, 1.64184, -0.0121816, 3.85466e-05, 174.782, -5.20096, 0.102772, -0.00123916, 5.73468e-06);
      
        
      fMultCutLow = new TF1("fMultCutLow", "[0]+[1]*x+[2]*x*x+[3]*x*x*x - 2.*([4]+[5]*x+[6]*x*x+[7]*x*x*x+[8]*x*x*x*x)", 0, 100);
      fMultCutLow->SetParameters(1641.34, -47.0298, 0.453619, -0.0014682, 155.387, -3.86204, 0.0515487, -0.000519994, 2.47616e-06);
      
      fMultCutHigh = new TF1("fMultCutHigh", "[0]+[1]*x+[2]*x*x+[3]*x*x*x + 3.*([4]+[5]*x+[6]*x*x+[7]*x*x*x+[8]*x*x*x*x)", 0, 100);
      fMultCutHigh->SetParameters(1641.34, -47.0298, 0.453619, -0.0014682, 155.387, -3.86204, 0.0515487, -0.000519994, 2.47616e-06);
      
      
      //fMultMultPVCutLow = new TF1("fMultMultPVCutLow", "[0]+[1]*x+[2]*x*x - 1.*([3]+[4]*x)", 0, 5000);
      //fMultMultPVCutLow->SetParameters(-0.74275, 0.670436, -4.84139e-05, 3.31157, 0.0338073);
      
      //fMultMultPVCutHigh = new TF1("fMultMultPVCutHigh", "[0]+[1]*x+[2]*x*x + 2.*([3]+[4]*x)", 0, 5000);
      //fMultMultPVCutHigh->SetParameters(-0.74275, 0.670436, -4.84139e-05, 3.31157, 0.0338073);
      
      
      
      /*
      //lhc23zzh_apass1
      fPhiCutLow = new TF1("fPhiCutLow", "0.06/x+pi/18.0-0.04", 0, 100);
      fPhiCutHigh = new TF1("fPhiCutHigh", "0.1/x+pi/18.0+0.04", 0, 100);
      
      
      fMultPVCutLow = new TF1("fMultPVCutLow", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x - 3.5*([5]+[6]*x+[7]*x*x+[8]*x*x*x+[9]*x*x*x*x)", 0, 100);
      fMultPVCutLow->SetParameters(3215.4, -114.114, 1.67185, -0.0123781, 3.90068e-05, 175.441, -5.01304, 0.0956269, -0.00114883, 5.34871e-06);
      
      fMultPVCutHigh = new TF1("fMultPVCutHigh", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x + 3.5*([5]+[6]*x+[7]*x*x+[8]*x*x*x+[9]*x*x*x*x)", 0, 100);
      fMultPVCutHigh->SetParameters(3215.4, -114.114, 1.67185, -0.0123781, 3.90068e-05, 175.441, -5.01304, 0.0956269, -0.00114883, 5.34871e-06);
      
        
      fMultCutLow = new TF1("fMultCutLow", "[0]+[1]*x+[2]*x*x+[3]*x*x*x - 2.*([4]+[5]*x+[6]*x*x+[7]*x*x*x+[8]*x*x*x*x)", 0, 100);
      fMultCutLow->SetParameters(1713.66, -49.3204, 0.478952, -0.00156589, 145.05, -3.44925, 0.0442435, -0.000445433, 2.14738e-06);
      
      fMultCutHigh = new TF1("fMultCutHigh", "[0]+[1]*x+[2]*x*x+[3]*x*x*x + 3.*([4]+[5]*x+[6]*x*x+[7]*x*x*x+[8]*x*x*x*x)", 0, 100);
      fMultCutHigh->SetParameters(1713.66, -49.3204, 0.478952, -0.00156589, 145.05, -3.44925, 0.0442435, -0.000445433, 2.14738e-06);
      */
  ...
  void process(Colls::iterator const& collision, BCsInfos const& bcs, FilteredTracks const& tracks)
  {
    ...
    if (zvtx < -990)
      ...
      /*
      //new cut
      if (multTrk < fMultMultPVCutLow->Eval(multNTracksPV))
          return;
          
      if (multTrk > fMultMultPVCutHigh->Eval(multNTracksPV))
          return;
      */
    ...
    for (auto& track : tracks) {
      ...
      Double_t resGap = (QxnGapA * QxnGapC + QynGapA * QynGapC);
      histos.fill(HIST("res"), t0cCentr, resGap);

      histos.fill(HIST("QxnA"), t0cCentr, QxnGapA);
      histos.fill(HIST("QxnC"), t0cCentr, QxnGapC);

      histos.fill(HIST("QynA"), t0cCentr, QynGapA);
      histos.fill(HIST("QynC"), t0cCentr, QynGapC);
