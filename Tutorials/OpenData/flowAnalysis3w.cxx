...
struct flow_base {
  ...
  void init(InitContext&) {
      ...
      */
      ...
      //test3
      fMultPVCutLow = new TF1("fMultPVCutLow", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x - 3.5*([5]+[6]*x+[7]*x*x+[8]*x*x*x+[9]*x*x*x*x)", 0, 100);
      fMultPVCutLow->SetParameters(3259.28, -118.671, 1.88166, -0.0161182, 6.09896e-05, 157.079, -3.59144, 0.0424976, -0.000343135, 1.2064e-06);
      
      fMultPVCutHigh = new TF1("fMultPVCutHigh", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x + 3.5*([5]+[6]*x+[7]*x*x+[8]*x*x*x+[9]*x*x*x*x)", 0, 100);
      fMultPVCutHigh->SetParameters(3259.28, -118.671, 1.88166, -0.0161182, 6.09896e-05, 157.079, -3.59144, 0.0424976, -0.000343135, 1.2064e-06);
      
        
      fMultCutLow = new TF1("fMultCutLow", "[0]+[1]*x+[2]*x*x+[3]*x*x*x - 3.*([4]+[5]*x+[6]*x*x+[7]*x*x*x+[8]*x*x*x*x)", 0, 100);
      fMultCutLow->SetParameters(2013.76, -61.0317, 0.643698, -0.00238009, 97.3547, -1.74784, 0.0159052, -0.000147846, 6.75935e-07);
      
      fMultCutHigh = new TF1("fMultCutHigh", "[0]+[1]*x+[2]*x*x+[3]*x*x*x + 3.*([4]+[5]*x+[6]*x*x+[7]*x*x*x+[8]*x*x*x*x)", 0, 100);
      fMultCutHigh->SetParameters(2013.76, -61.0317, 0.643698, -0.00238009, 97.3547, -1.74784, 0.0159052, -0.000147846, 6.75935e-07);
